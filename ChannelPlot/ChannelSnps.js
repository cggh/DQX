...
WARNING
DEPRECIATED: replaced by ChannelSnps2

************************************************************************************************************************************
***********************************************************************************************************************************/


define(["jquery", "DQX/DocEl", "DQX/Msg", "DQX/ChannelPlot/ChannelCanvas", "DQX/DataFetcher/DataFetcherSnp"],
    function ($, DocEl, Msg, ChannelCanvas, DataFetcherSnp) {
        ...
        ChannelSnps.Channel = function (iid, imyDataFetcher) {
            ...
            that.draw = function (drawInfo, args) {
                ...
                if (!that.myDataFetcher.IsDataReady(this.PosMin, this.PosMax))
                    alldataready = false;
