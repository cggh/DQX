...
DQX.GMaps.KML = function (iid, imapobject, kmlurl) {
    var that = {};
...
DQX.GMaps.Polygon = function (iid, imapobject, data) {
    var that = {};
...
DQX.GMaps.PointSet = function (iid, imapobject, iminzoomlevel, bitmapfile) {
    var that = {};
    ...
    that._handleOnPointClicked = function (pointnr) {
        ...
        DQX.Msg.send({ type: 'ClickMapPoint', id: this.myID }, this.myPointSet[pointnr].id);
    }
